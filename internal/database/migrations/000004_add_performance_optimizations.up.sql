-- Add index on game_sessions user_id and score for faster aggregation
CREATE INDEX IF NOT EXISTS idx_game_sessions_user_score ON game_sessions(user_id, score);
